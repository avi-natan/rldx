...
from p_pipeline import run_W_single_experiment, run_SN_single_experiment, run_SIF_single_experiment, run_SIF2_single_experiment, run_SN2_single_experiment, run_W2_single_experiment
...
def single_experiment_LunarLander_W2():
    # changable test settings - weak fault model (W)
    exp_durations_in_ms = []
    exp_memories_at_end = []
    exp_memories_max = []
...
def single_experiment_LunarLander_SN2():
    # changable test settings - strong fault model non-intermittent faults (SN)
    exp_durations_in_ms = []
    exp_memories_at_end = []
    exp_memories_max = []
...
def single_experiment_LunarLander_SIF2():
    # changable test settings - strong fault model intermittent faults (SIF)
    exp_durations_in_ms = []
    exp_memories_at_end = []
    exp_memories_max = []
...
# ========================================== LunerLander ==========================================
# =================================================================================================
def single_experiment_FrozenLake_W():
    # changable test settings - weak fault model (W)
    exp_durations_in_ms = []
    exp_memories_at_end = []
    exp_memories_max = []
...
def single_experiment_FrozenLake_SN():
    # changable test settings - strong fault model non-intermittent faults (SN)
    exp_durations_in_ms = []
    exp_memories_at_end = []
    exp_memories_max = []
...
def single_experiment_FrozenLake_W2():
    # changable test settings - weak fault model (W)
    exp_durations_in_ms = []
    exp_memories_at_end = []
    exp_memories_max = []
...
def single_experiment_FrozenLake_SN2():
    # changable test settings - strong fault model non-intermittent faults (SN)
    exp_durations_in_ms = []
    exp_memories_at_end = []
    exp_memories_max = []
...
def single_experiment_FrozenLake_SIF2():
    # changable test settings - strong fault model intermittent faults (SIF)
    exp_durations_in_ms = []
    exp_memories_at_end = []
    exp_memories_max = []
